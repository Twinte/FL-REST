...
#################################################################
# FedRolex Baseline (Alam et al., NeurIPS 2022)
# Rolling window neuron extraction
#################################################################
...
# --- Strategy: FedRolex ---
export CLIENT_ALGO="FedRolex"
export AGGREGATION_STRATEGY="FedRolex"
export SERVER_LEARNING_RATE=1.0
export SERVER_MOMENTUM=0.9

# FedPrune params (ignored by FedRolex, but needed in env for config.py)
...
echo "▶️ Starting FedRolex baseline with $TOTAL_CLIENTS clients..."
