...
def parse_fl_log(log_path):
    ...
    # Docker prefix: "client_001-1  | INFO:client.algorithms..."
    # "FedPrune: Training 314 neurons across 6 layers"
    client_neurons_pattern = re.compile(
        r"(client_\d+).*FedPrune: Training (\d+) neurons across (\d+) layers")
...
if __name__ == "__main__":
    ...
    if df_eval.empty:
        print("No evaluation metrics found. Did the simulation complete?")
    else:
